...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    const savedBillItems = await BillItem.insertMany(billItems, { session });
...
router.put('/:id', async (req, res) => {
  ...
  try {
    ...
    await BillItem.deleteMany({ billId: req.params.id }, { session });
...
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    // Delete bill
    const deletedBill = await Bill.findByIdAndDelete(req.params.id, { session });
